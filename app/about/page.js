          ...
          <div class="bodyCon">
            ...
            <section>
              <div className="ab-cont pt-16 lg:pt-20 gap-10 flex flex-col justify-center items-center text-center">
                <p>
                  MsVick is a leading brand that provides a range of top-notch
                  solutions within the Tech ecosystem, including brand, design,
                  product, development, community building and talent grooming
                  consultation services.
                </p>
                <p>
                  MsVick is known to offer exceptional services with resilience,
                  excellence, and elegance, to clients in various industries,
                  including early-stage startups building SaaS, Healthcare and
                  Lifestyle products.
                </p>
                <p>
                  Community lies at the heart of the MsVick brand. MsVick
                  actively engages in community building initiatives to create a
                  positive impact on the Tech ecosystem, promoting shared
                  learning, diversity, sustainability, and social
                  responsibility.
                </p>
              </div>
              ...
              <div className="pt-20 ab-cont text-center">
                ...
                <p className="pt-10 lg:pt-6">
                  MsVick upholds humanity, integrity and possibility mentality
                  as its core values - in treating everyone with respect and
                  empathy while being transparent in dealings with people and
                  clients.
                </p>
              </div>
            </section>
