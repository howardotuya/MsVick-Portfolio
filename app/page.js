...
export default function Home() {
  useEffect(() => {
    ...
    imageDivThree.addEventListener("mouseleave", function () {
      imageThree.style.transition =
        "transform 300ms ease-out, object-position 300ms ease-out, right 300ms ease-out";
    ...
    imageDivThree.addEventListener("mouseenter", function () {
      imageThree.style.transition =
        "transform 300ms ease-out, right 300ms ease-out, object-position 300ms ease-out";
          ...
          <div className="bodyCon">
            <section className="pt-112 ">
              <div className="flex gap-4 flex-col justify-center items-center">
                ...
                <p className="headp text-center">
                  Infusing human touch to digital experiences and creating
            ...
            <section className="flex flex-col lg:flex-row gap-5 pt-112x">
              <Link href="portfolio" className="card one">
                <div className="cardH w-full h-full relative border">
                  <Image
                    className="object-cover oneI obj w-full h-full"
                    src={h1}
                    alt="Portfolio"
                    quality={100}
                    priority
              ...
              <Link href="/community" className="card three">
                <div className="cardH w-full h-full relative border">
                  <Image
                    className="object-cover  threeI w-full relative h-full object-right"
                    src={h3}
                    alt="Community"
                    quality={100}
                    priority
